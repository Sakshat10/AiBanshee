export const Button = ({ text }) => {
  return (
    <div>
      <a
        href="#_"
        className="relative inline-flex items-center justify-start px-6 py-3 overflow-hidden font-medium transition-all bg-white rounded w-fit hover:bg-white group"
      >
